...
class FillPermissionsForKeyType extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForKeyType constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.key-type',
            'admin.key-type.index',
            'admin.key-type.create',
            'admin.key-type.show',
            'admin.key-type.edit',
            'admin.key-type.delete',
            'admin.key-type.bulk-delete',
        ]);
