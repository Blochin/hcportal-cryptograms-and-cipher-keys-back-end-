...
class FillPermissionsForCipherType extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCipherType constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.cipher-type',
            'admin.cipher-type.index',
            'admin.cipher-type.create',
            'admin.cipher-type.show',
            'admin.cipher-type.edit',
            'admin.cipher-type.delete',
            'admin.cipher-type.bulk-delete',
        ]);
