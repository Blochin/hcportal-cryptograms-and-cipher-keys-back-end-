...
class FillPermissionsForCryptograms extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCryptogramconstructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.cryptogram',
            'admin.cryptogram.index',
            'admin.cryptogram.create',
            'admin.cryptogram.show',
            'admin.cryptogram.edit',
            'admin.cryptogram.delete',
            'admin.cryptogram.bulk-delete',
        ]);
