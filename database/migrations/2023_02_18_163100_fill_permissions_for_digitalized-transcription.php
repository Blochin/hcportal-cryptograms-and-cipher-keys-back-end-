...
class FillPermissionsForDigitalizedTranscription extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForDigitalizedTranscription constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.digitalized-transcription',
            'admin.digitalized-transcription.index',
            'admin.digitalized-transcription.create',
            'admin.digitalized-transcription.show',
            'admin.digitalized-transcription.edit',
            'admin.digitalized-transcription.delete',
            'admin.digitalized-transcription.bulk-delete',
        ]);
