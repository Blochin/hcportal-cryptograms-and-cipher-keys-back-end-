...
class FillPermissionsForSolution extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForSolution constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.solution',
            'admin.solution.index',
            'admin.solution.create',
            'admin.solution.show',
            'admin.solution.edit',
            'admin.solution.delete',
            'admin.solution.bulk-delete',
        ]);
