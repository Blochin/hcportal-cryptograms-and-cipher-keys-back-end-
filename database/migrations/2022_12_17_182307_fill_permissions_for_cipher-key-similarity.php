...
class FillPermissionsForCipherKeySimilarity extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCipherKeySimilarity constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.cipher-key-similarity',
            'admin.cipher-key-similarity.index',
            'admin.cipher-key-similarity.create',
            'admin.cipher-key-similarity.show',
            'admin.cipher-key-similarity.edit',
            'admin.cipher-key-similarity.delete',
            'admin.cipher-key-similarity.bulk-delete',
        ]);
