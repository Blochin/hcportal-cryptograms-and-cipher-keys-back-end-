...
class FillPermissionsForCipherKey extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCipherKey constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.cipher-key',
            'admin.cipher-key.index',
            'admin.cipher-key.create',
            'admin.cipher-key.show',
            'admin.cipher-key.edit',
            'admin.cipher-key.delete',
            'admin.cipher-key.bulk-delete',
        ]);
