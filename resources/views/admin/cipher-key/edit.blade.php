    ...
    <div class="container-xl">
        <div class="card">
            ...
            <cipher-key-form :action="'{{ $cipherKey->resource_url }}'" :data="{{ $cipherKey->toJson() }}"
                ...
                :folders="{{ $folders->toJSON() }}" :tags="{{ $tags->toJSON() }}" :edit="true" v-cloak inline-template>
                <div>
                            ...
                            <div class="card-body">
                                <div class="row mb-3">
                                    <div class="col-12">
                                        ...
                                        <p class="p-0 m-0 mb-2">{!! $cipherKey->state_badge !!} </p>
                                        <i class="col-form-label">Note: {{ $cipherKey->state->note ?: 'None' }}</i>
                                    </div>
                                </div>
                                <div class="row">
