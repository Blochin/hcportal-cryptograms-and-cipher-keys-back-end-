            ...
            <div class="col">
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-align-justify"></i> {{ trans('admin.cipher-key.actions.index') }}
                        <a class="btn btn-primary btn-spinner btn-sm pull-right m-b-0 ml-2"
                        href="{{ url('admin/cipher-keys/create') }}" role="button"><i class="fa fa-plus"></i>&nbsp;
                        {{ trans('admin.cipher-key.actions.create') }}</a>
                    ...
                    <div class="card-body" v-cloak>
                        <div class="card-block">
                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th>
                                            {{ trans('admin.cipher-key.columns.date') }}</th>
                                        <th :column="'state'">
                                        ...
                                        <td class="bg-bulk-info d-table-cell text-center" colspan="13">
                                            <span
                                                ...
                                                @{{ clickedBulkItemsCount }}. <a href="#" class="text-primary"
                                                    @click="onBulkItemsClickedAll('/admin/cipher-keys')"
                                            ...
                                            <span class="pull-right pr-2">
                                                <button class="btn btn-sm btn-danger pr-3 pl-3"
                                                    @click="bulkDelete('/admin/cipher-keys/bulk-destroy')">{{ trans('brackets/admin-ui::admin.btn.delete') }}</button>
                                            </span>
                            ...
                            <div class="no-items-found" v-if="!collection.length > 0">
                                ...
                                <a class="btn btn-primary btn-spinner" href="{{ url('admin/cipher-keys/create') }}"
                                    role="button"><i class="fa fa-plus"></i>&nbsp;
                                    {{ trans('admin.cipher-key.actions.create') }}</a>
                            </div>
                        </div>
