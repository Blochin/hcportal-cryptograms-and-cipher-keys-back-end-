<div class="sidebar">
    <nav class="sidebar-nav">
        <ul class="nav">
            ...
            <li class="nav-item"><a class="nav-link" href="{{ url('admin/digitalized-transcriptions') }}"><i class="nav-icon icon-plane"></i> {{ trans('admin.digitalized-transcription.title') }}</a></li>
