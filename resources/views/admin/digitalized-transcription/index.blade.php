...
@section('title', trans('admin.digitalized-transcription.actions.index'))

@section('body')

    <digitalized-transcription-listing :data="{{ $data->toJson() }}"
        :url="'{{ url('admin/digitalized-transcriptions') }}'" inline-template>

        <div class="row">
            <div class="col">
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-align-justify"></i> {{ trans('admin.digitalized-transcription.actions.index') }}
                        <a class="btn btn-primary btn-spinner btn-sm pull-right m-b-0"
                            href="{{ url('admin/digitalized-transcriptions/create') }}" role="button"><i
                                class="fa fa-plus"></i>&nbsp;
                            {{ trans('admin.digitalized-transcription.actions.create') }}</a>
                    </div>
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'id'">
                                            {{ trans('admin.digitalized-transcription.columns.id') }}</th>
                                        <th is='sortable' :column="'cipher_key_id'">
                                            {{ trans('admin.digitalized-transcription.columns.cipher-keys') }}</th>
                                            <th is='sortable' :column="'created_by'">
                                                {{ trans('admin.digitalized-transcription.columns.created_by') }}</th>
                                        <th is='sortable' :column="'digitalized_version'">
                                            {{ trans('admin.digitalized-transcription.columns.digitalized_version') }}
                                        </th>
                                        <th is='sortable' :column="'digitalization_date'">
                                            {{ trans('admin.digitalized-transcription.columns.digitalization_date') }}
                                        </th>
                                        ...
                                        <td class="bg-bulk-info d-table-cell text-center" colspan="7">
                                            <span
                                                ...
                                                @{{ clickedBulkItemsCount }}. <a href="#" class="text-primary"
                                                    @click="onBulkItemsClickedAll('/admin/digitalized-transcriptions')"
                                            ...
                                            <span class="pull-right pr-2">
                                                <button class="btn btn-sm btn-danger pr-3 pl-3"
                                                    @click="bulkDelete('/admin/digitalized-transcriptions/bulk-destroy')">{{ trans('brackets/admin-ui::admin.btn.delete') }}</button>
                                            </span>
    ...
    </digitalized-transcription-listing>
