...
@section('body')
    ...
    <cipher-key-similarity-listing :data="{{ $data->toJson() }}" :url="'{{ url('admin/cipher-key-similarities') }}'"
        inline-template>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <a class="btn btn-primary btn-spinner btn-sm pull-right m-b-0"
                            href="{{ url('admin/cipher-key-similarities/create') }}" role="button"><i
                                class="fa fa-plus"></i>&nbsp;
                            {{ trans('admin.cipher-key-similarity.actions.create') }}</a>
                    </div>
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'id'">
                                            {{ trans('admin.cipher-key-similarity.columns.id') }}</th>
                                        <th is='sortable' :column="'name'">
                                            {{ trans('admin.cipher-key-similarity.columns.name') }}</th>
                                        ...
                                        <td class="bg-bulk-info d-table-cell text-center" colspan="4">
                                            <span
                                                ...
                                                @{{ clickedBulkItemsCount }}. <a href="#" class="text-primary"
                                                    @click="onBulkItemsClickedAll('/admin/cipher-key-similarities')"
                                            ...
                                            <span class="pull-right pr-2">
                                                <button class="btn btn-sm btn-danger pr-3 pl-3"
                                                    @click="bulkDelete('/admin/cipher-key-similarities/bulk-destroy')">{{ trans('brackets/admin-ui::admin.btn.delete') }}</button>
                                            </span>
