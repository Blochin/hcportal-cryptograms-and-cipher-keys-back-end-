                                ...
                                <td class="bg_white email-section"
                                    ...
                                    <div class="heading-section"
                                        ...
                                        <span class="subheading"
                                            ...
                                            New Cryptogram - {{ $cryptogram->name }}
                                        </span>
                                        <h2
                                            ...
                                            </b> added a new Cryptogram.
                                        </h2>
                                        <p style="color:#000;margin: 0"><b>Cryptogram name:</b>
                                            {{ $cryptogram->name }}</p>
                                        <br>
                                        <a href="{{ $cryptogram->resource_url }}/edit" class="btn btn-primary"
                                            style="margin-top:20px">Show cryptogram</a>
