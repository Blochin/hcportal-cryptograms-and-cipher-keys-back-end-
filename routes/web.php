...
Route::middleware(['auth:' . config('admin-auth.defaults.guard'), 'admin'])->group(static function () {
    Route::prefix('admin')->namespace('App\Http\Controllers\Admin')->name('admin/')->group(static function () {
        ...
        Route::post('/cryptograms/bulk-upload', 'CryptogramsController@processBulkUpload')->name('process-cryptogram-bulk-upload');
        Route::post('/cipher-keys/bulk-upload', 'CipherKeysController@processBulkUpload')->name('process-cipher-key-bulk-upload');
    });
});
...
Route::middleware(['auth:' . config('admin-auth.defaults.guard'), 'admin'])->group(static function () {
    Route::prefix('admin')->namespace('App\Http\Controllers\Admin')->name('admin/')->group(static function () {
        Route::prefix('cipher-keys')->name('cipher-keys/')->group(static function () {
            ...
            Route::get('/bulk-upload', 'CipherKeysController@bulkUpload')->name('key-bulk-upload');
        });
    });
});
...
Route::middleware(['auth:' . config('admin-auth.defaults.guard'), 'admin'])->group(static function () {
    Route::prefix('admin')->namespace('App\Http\Controllers\Admin')->name('admin/')->group(static function () {
        Route::prefix('cryptograms')->name('cryptograms/')->group(static function () {
            ...
            Route::get('/bulk-upload', 'CryptogramsController@bulkUpload')->name('bulk-upload');
        });
    });
});
